...
VMDSVR=function(data,k,alpha,tau,K,DC,init,tol, ker.funct="",svm.type=""){
  ...
  TotalIMF =  K
  output_f=list(Total_No_IMF=TotalIMF, Prediction_Accuracy_VMDSVR =prediction_accuracy, Final_Prediction_VMDSVR =final_prediction)
  return(output_f)
}
